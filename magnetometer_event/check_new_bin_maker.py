...
def plot_histograms(bins_sorted, time_day_bins, time_of_event, mag_events, fancy_latex = False):
    borders = [
    ...
    plt.title(
        f"2018 {station} \n"+\
        f"Max magnetometer value of a substorm event with {mag_events} substorms collected. \n"+\
...
def plot_all_mag_events(events_collection, bins_sorted,mag_events, fancy_latex = False):
...
def plot_all_ROTI_events(events_collection_ROTI, bins_sorted,mag_events,fancy_latex = False):
...
def plot_all_gps_events(events_collection_gps,time_gps_sorted, bins_sorted,GPS_events, fancy_latex = False):
    borders = [bins_sorted[int((len(bins_sorted) - 1) / 3)],
        bins_sorted[int((len(bins_sorted) - 1) * 2 / 3)],]
...
#########################plotting data#########################
plot_histograms(bins_sorted,time_day_bins, time_of_event, mag_events, fancy_latex =False)
plot_all_mag_events(events_collection_sorted,bins_sorted,mag_events ,fancy_latex = False)
plot_all_ROTI_events(ROTI_event_sorted,bins_sorted, mag_events ,fancy_latex = False)
plot_all_gps_events(noise_gps_sorted, time_gps_sorted,bins_sorted, GPS_events, fancy_latex = False)

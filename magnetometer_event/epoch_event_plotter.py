...
def plot_ROTI_events(events_collection_ROTI, bins_sorted,mag_events,latex_style = False):
    ...
    plt.plot(nfive_percentile, linewidth = 3, color = "green", label="95th percentile")
    plt.plot(median_event, linewidth=3, color="black", label="median value")
    plt.title(f"All recorded substorms showed by ROT at location {location} in 2018 \n"+\
              f"{mag_events} substorms collected")
    plt.xlabel("Minutes")
...
def plot_all_data_events(mag,ROTI,gps,latex_style=False):
    ...
    ax1[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax1[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax1[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),median_event, linewidth = 2.5, color = "black")
    ...
    ax1[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax1[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax1[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),median_event, linewidth = 2.5, color="black")
    ...
    ax1[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],nfive_percentile[::60], linewidth = 2.5, color = "green", label="95th percentile")
    ax1[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],five_percentile[::60], linewidth = 2.5, color = "red", label="5th percentile")
    ax1[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],median_event[::60], linewidth = 2.5, color="black", label="median value")
    ...
    ax2[0].plot(np.zeros(2000),np.linspace(np.min(mag),np.max(mag),2000),"b", linewidth =2)
    ax2[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax2[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax2[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),median_event, linewidth = 2.5, color = "black")
    ...
    ax2[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax2[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax2[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),median_event, linewidth=2.5, color="black")
    ...
    ax2[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],nfive_percentile[::60], linewidth = 2.5, color = "green", label="95th percentile")
    ax2[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],five_percentile[::60], linewidth = 2.5, color = "red", label="5th percentile")
    ax2[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],median_event[::60], linewidth = 2.5, color="black", label="median value")
    ...
    ax3[0].plot(np.zeros(2000),np.linspace(np.min(mag),np.max(mag),2000),"b", linewidth =2)
    ax3[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax3[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax3[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),median_event, linewidth = 2.5, color = "black")
    ...
    ax3[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax3[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax3[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),median_event, linewidth=2.5, color="black")
    ...
    ax3[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],nfive_percentile[::60], linewidth = 2.5, color = "green", label="95th percentile")
    ax3[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],five_percentile[::60], linewidth = 2.5, color = "red", label="5th percentile")
    ax3[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],median_event[::60], linewidth = 2.5, color="black", label="median value")
    ...
    ax4[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax4[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax4[0].plot(np.linspace(start_x,end_x, len(mag[0,:])),median_event, linewidth = 2.5, color = "black")
    ...
    ax4[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),five_percentile, linewidth = 2.5, color = "red")
    ax4[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),nfive_percentile, linewidth = 2.5, color = "green")
    ax4[1].plot(np.linspace(start_x,end_x, len(ROTI[0,:])),median_event, linewidth=2.5, color="black")
    ...
    ax4[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],nfive_percentile[::60], linewidth = 2.5, color = "green", label="95th percentile")
    ax4[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],five_percentile[::60], linewidth = 2.5, color = "red", label="5th percentile")
    ax4[2].plot(np.linspace(start_x,end_x, len(gps[0,:]))[::60],median_event[::60], linewidth = 2.5, color="black", label="median value")
